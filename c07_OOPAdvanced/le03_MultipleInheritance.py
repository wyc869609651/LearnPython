...
# 正确的做法是采用多重继承。首先，主要的类层次仍按哺乳类和鸟类设计：
class Animal(object):
    pass
...
# 如果要“混入”额外的功能，通过多重继承既可以实现，比如，让Ostrich除了继承自Bird外，
# 再同时继承Runnable。这种设计通常称之为MixIn。

# 为了更好地看出继承关系，我们把Runnable和Flyable改为RunnableMixIn和FlyableMixIn。
# 类似的，你还可以定义出肉食动物CarnivorousMixIn和植食动物HerbivoresMixIn，让某个动物
# 同时拥有好几个MixIn:
...
# 而要同时服务多个用户就必须使用多进程或多线程模型，这两种模型由ForkingMixIn和ThreadingMixIn
